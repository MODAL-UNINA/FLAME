...
class FlowerClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters: List[np.ndarray], config: Dict[str, str]
      ...
      self.set_parameters(parameters)
      loss, accuracy, f1 = test(self.model, testloader, device=DEVICE)
...
with open(f'../CICDDoS2019/{output_file}/Results_{zero_day}/Client{client_id}_performance.pkl', 'wb') as f:
    pickle.dump(D, f)
